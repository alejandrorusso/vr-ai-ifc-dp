...
\item \student{M. Vassena}, \me{A. Russo}, D. Garg,
  ...
  on Principles of Programming Languages (\textbf{POPL}), 2019
  (\textbf{distinguished paper}), 2019.
  %
  I came up with several proof techniques to complete our mechanized proofs.
  %
