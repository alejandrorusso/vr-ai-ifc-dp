...
%
Current LLM agent frameworks are \emph{insecure by design}~\cite{Zhao:ParasiticMCP26} (see Figure~\ref{fig:attack}): they enforce only coarse-grained \emph{access control}, regulating which tools an agent may invoke but providing no guarantees on how data propagates \emph{after} access is
granted.
%
