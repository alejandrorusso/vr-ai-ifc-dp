...
routinely bypassed.
%
None of these approaches provide no end-to-end, formally verifiable security
guarantees.
...
%
Solutions span the spectrum from hardware mechanisms (e.g., Intel
Control-flow Enforcement Technology and shadow stacks) to compiler
instrumentation and OS-level enforcement, and CFI is now a standard
