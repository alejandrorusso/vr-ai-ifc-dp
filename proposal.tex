...
corrupted or overwritten by untrusted sources) throughout an 
agentic loop.
%
Information Flow Control (IFC)~\cite{Sabelfeld:Myers:JSAC} is a principled
approach to both properties: rather than merely restricting \emph{access}, it
tracks \emph{where data goes} after access is granted, enforcing end-to-end
security policies.
%
...
%
First, \emph{label creep}: once an agent reads a sensitive file its label is
...
mitigating label creep, and without requiring a new trust model?}
